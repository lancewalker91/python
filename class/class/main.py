...
class ControlHandler(WebSocketHandler):
    help_str = """usage:
        ...
        text plan_id phone token repeat start end content -- 发文本信息（发送时间为starth到end之间的随机数之后，发repeat次）
        texts plan_id phone num repeat start end content -- 发文本信息（发送从phone开始，连着num个手机号）
